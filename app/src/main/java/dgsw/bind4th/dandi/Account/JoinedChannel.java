...
import dgsw.bind4th.dandi.RecyclerView_main.JoinedChannelAdapter;
...
public class JoinedChannel extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    ArrayList<dgsw.bind4th.dandi.Model.JoinedChannel> joinedChannel = new ArrayList<>();
        ...
        res.enqueue(new Callback<Response<Data>>() {
            ...
            public void onResponse(Call<Response<Data>> call, retrofit2.Response<Response<Data>> response) {
                ...
                if(response.code() == 200){
                    ...
                    joinedChannel = (ArrayList<dgsw.bind4th.dandi.Model.JoinedChannel>) response.body().getData().getJoinedChannel();
